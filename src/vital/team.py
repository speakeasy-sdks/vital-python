...
class Team:
    ...
    def create(self, request: shared.TeamCreate, retries: Optional[utils.RetryConfig] = None) -> operations.CreateTeamV2TeamPostResponse:
        r"""Create Team
        Create Team.
        """
    ...
    def create_api_key(self, create_api_key_body: shared.CreateAPIKeyBody, team_id: str, retries: Optional[utils.RetryConfig] = None) -> operations.CreateAPIKeyV2TeamTeamIDApikeyPostResponse:
        r"""Create Api Key
        Create api key.
        """
    ...
    def create_priority(self, priority_create: shared.PriorityCreate, team_id: str, retries: Optional[utils.RetryConfig] = None) -> operations.CreatePriorityV2TeamTeamIDPriorityPostResponse:
        r"""Create Priority
    ...
    def delete_api_key(self, api_key_id: str, team_id: str, retries: Optional[utils.RetryConfig] = None) -> operations.DeleteAPIKeyV2TeamTeamIDApikeyAPIKeyIDDeleteResponse:
        r"""Delete Api Key
    ...
    def get(self, team_id: str, retries: Optional[utils.RetryConfig] = None) -> operations.GetTeamV2TeamTeamIDGetResponse:
        r"""Get Team
        Get team.
        """
    ...
    def get_api_keys(self, team_id: str, retries: Optional[utils.RetryConfig] = None) -> operations.GetAPIKeysForTeamV2TeamTeamIDApikeysGetResponse:
    ...
    def get_config(self, retries: Optional[utils.RetryConfig] = None) -> operations.GetTeamConfigV2TeamLinkConfigGetResponse:
        r"""Get Team Config
        Post teams.
        """
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
    ...
    def get_source_priorities(self, data_type: Optional[str] = None, retries: Optional[utils.RetryConfig] = None) -> operations.GetSourcePrioritiesV2TeamSourcePrioritiesGetResponse:
    ...
    def get_user_count(self, team_id: str, retries: Optional[utils.RetryConfig] = None) -> operations.GetTeamUserCountV2TeamTeamIDUsersCountGetResponse:
    ...
    def get_webhook_url(self, retries: Optional[utils.RetryConfig] = None) -> operations.GetSvixWebhookURLV2TeamSvixURLGetResponse:
    ...
    def rotate_api_key_v2_team_team_id_apikey_api_key_id_rotate_patch(self, api_key_id: str, team_id: str, retries: Optional[utils.RetryConfig] = None) -> operations.RotateAPIKeyV2TeamTeamIDApikeyAPIKeyIDRotatePatchResponse:
        r"""Rotate Api Key
        ...
        def do_request():
            return client.request('PATCH', url, headers=headers)
    ...
    def search_users_by_uuid(self, query_id: Optional[str] = None, retries: Optional[utils.RetryConfig] = None) -> operations.SearchTeamUsersByUUIDOrClientUserIDV2TeamUsersSearchGetResponse:
    ...
    def update_api_key_label_v2_team_team_id_apikey_api_key_id_patch(self, update_api_key_body: shared.UpdateAPIKeyBody, api_key_id: str, team_id: str, retries: Optional[utils.RetryConfig] = None) -> operations.UpdateAPIKeyLabelV2TeamTeamIDApikeyAPIKeyIDPatchResponse:
    ...
    def update_source_priorities_v2_team_source_priorities_patch(self, team_id: str, retries: Optional[utils.RetryConfig] = None) -> operations.UpdateSourcePrioritiesV2TeamSourcePrioritiesPatchResponse:
        ...
        def do_request():
            return client.request('PATCH', url, params=query_params, headers=headers)
    ...
    def update_team_v2_team_team_id_patch(self, team_update: shared.TeamUpdate, team_id: str, retries: Optional[utils.RetryConfig] = None) -> operations.UpdateTeamV2TeamTeamIDPatchResponse:
        r"""Update Team
        Update team.
        """
