...
class Link:
    ...
    def check_token_state(self) -> operations.CheckLinkTokenStateV2LinkStateGetResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='check_link_token_state_v2_link_state_get', oauth2_scopes=[], security_source=None)
        ...
        res = operations.CheckLinkTokenStateV2LinkStateGetResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def check_token_validity(self, request: shared.LinkTokenBase) -> operations.CheckTokenValidV2LinkTokenIsValidPostResponse:
        r"""Check Token Valid"""
        hook_ctx = HookContext(operation_id='check_token_valid_v2_link_token_isValid_post', oauth2_scopes=[], security_source=None)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
        ...
        res = operations.CheckTokenValidV2LinkTokenIsValidPostResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def connect_ble_provider(self, manual_connection_data: shared.ManualConnectionData, provider: operations.ProvidersThatAreManuallyAddedDevicesSuchAsBleDevicesAndGeneratedData) -> operations.ConnectBleProviderV2LinkProviderManualProviderPostResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='connect_ble_provider_v2_link_provider_manual__provider__post', oauth2_scopes=[], security_source=None)
        ...
        res = operations.ConnectBleProviderV2LinkProviderManualProviderPostResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def connect_email_auth(self, request: shared.EmailAuthLink) -> operations.ConnectEmailAuthV2LinkAuthEmailPostResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='connect_email_auth_v2_link_auth_email_post', oauth2_scopes=[], security_source=None)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
        ...
        res = operations.ConnectEmailAuthV2LinkAuthEmailPostResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def connect_email_provider(self, email_provider_auth_link: shared.EmailProviderAuthLink, provider: operations.EmailProvidersThatRequireEmailsFreestyleAuth) -> operations.ConnectEmailAuthProviderV2LinkProviderEmailProviderPostResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='connect_email_auth_provider_v2_link_provider_email__provider__post', oauth2_scopes=[], security_source=None)
        ...
        res = operations.ConnectEmailAuthProviderV2LinkProviderEmailProviderPostResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def connect_individual_provider(self, individual_provider_data: shared.IndividualProviderData, provider: operations.ProvidersThatRequirePasswordAuthWhoopRenphoPelotonZwift, x_vital_link_client_region: Optional[str] = None) -> operations.ConnectIndividualProviderV2LinkProviderPasswordProviderPostResponse:
        ...
        This connects auth providers that are password based.
        """
        hook_ctx = HookContext(operation_id='connect_individual_provider_v2_link_provider_password__provider__post', oauth2_scopes=[], security_source=None)
        ...
        res = operations.ConnectIndividualProviderV2LinkProviderPasswordProviderPostResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def connect_password_auth(self, password_auth_link: shared.PasswordAuthLink, x_vital_link_client_region: Optional[str] = None) -> operations.ConnectPasswordAuthV2LinkAuthPostResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='connect_password_auth_v2_link_auth_post', oauth2_scopes=[], security_source=None)
        ...
        res = operations.ConnectPasswordAuthV2LinkAuthPostResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def connect_provider(self, provider: str, x_vital_sdk_no_redirect: Optional[str] = None) -> operations.ConnectProviderV2LinkConnectProviderGetResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='connect_provider_v2_link_connect__provider__get', oauth2_scopes=[], security_source=None)
        ...
        res = operations.ConnectProviderV2LinkConnectProviderGetResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def create_demo_connection(self, request: shared.DemoConnectionCreationPayload) -> operations.CreateDemoConnectionV2LinkConnectDemoPostResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='create_demo_connection_v2_link_connect_demo_post', oauth2_scopes=[], security_source=None)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
        ...
        res = operations.CreateDemoConnectionV2LinkConnectDemoPostResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def create_token(self, user_id: str, expires_at: Optional[datetime] = None) -> operations.CreateTokenV2LinkCodeCreatePostResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='create_token_v2_link_code_create_post', oauth2_scopes=[], security_source=None)
        ...
        query_params = { **utils.get_query_params(operations.CreateTokenV2LinkCodeCreatePostRequest, request), **query_params }
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
        client = self.sdk_configuration.client
        ...
        res = operations.CreateTokenV2LinkCodeCreatePostResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def exchange_token(self, code: str) -> operations.ExchangeTokenV2LinkCodeExchangePostResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='exchange_token_v2_link_code_exchange_post', oauth2_scopes=[], security_source=None)
        ...
        query_params = { **utils.get_query_params(operations.ExchangeTokenV2LinkCodeExchangePostRequest, request), **query_params }
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
        client = self.sdk_configuration.client
        ...
        res = operations.ExchangeTokenV2LinkCodeExchangePostResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def generate(self, request: shared.LinkTokenExchange) -> operations.GenerateVitalLinkTokenV2LinkTokenPostResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='generate_vital_link_token_v2_link_token_post', oauth2_scopes=[], security_source=None)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
        ...
        res = operations.GenerateVitalLinkTokenV2LinkTokenPostResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def get_oauth_provider(self, oauth_provider: shared.OAuthProviders) -> operations.GetOauthProviderV2LinkProviderOauthOauthProviderGetResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='get_oauth_provider_v2_link_provider_oauth__oauth_provider__get', oauth2_scopes=[], security_source=None)
        ...
        res = operations.GetOauthProviderV2LinkProviderOauthOauthProviderGetResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def get_providers(self) -> operations.GetProvidersV2LinkProvidersGetResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='get_providers_v2_link_providers_get', oauth2_scopes=[], security_source=None)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
        ...
        res = operations.GetProvidersV2LinkProvidersGetResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def start_connect_process(self, request: shared.BeginLinkTokenRequest) -> operations.StartConnectProcessV2LinkStartPostResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='start_connect_process_v2_link_start_post', oauth2_scopes=[], security_source=None)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
        ...
        res = operations.StartConnectProcessV2LinkStartPostResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
