...
class Link:
    ...
    def connect_ble_provider(self, request: operations.ConnectBleProviderV2LinkProviderManualProviderPostRequest) -> operations.ConnectBleProviderV2LinkProviderManualProviderPostResponse:
    ...
    def connect_email_provider(self, request: operations.ConnectEmailAuthProviderV2LinkProviderEmailProviderPostRequest) -> operations.ConnectEmailAuthProviderV2LinkProviderEmailProviderPostResponse:
    ...
    def connect_individual_provider(self, request: operations.ConnectIndividualProviderV2LinkProviderPasswordProviderPostRequest) -> operations.ConnectIndividualProviderV2LinkProviderPasswordProviderPostResponse:
    ...
    def connect_password_auth(self, request: operations.ConnectPasswordAuthV2LinkAuthPostRequest) -> operations.ConnectPasswordAuthV2LinkAuthPostResponse:
    ...
    def connect_provider(self, request: operations.ConnectProviderV2LinkConnectProviderGetRequest) -> operations.ConnectProviderV2LinkConnectProviderGetResponse:
        r"""Connect Provider
        REQUEST_SOURCE: VITAL-LINK
        PROVIDER_TYPE: OAUTH
    ...
    def create_token(self, request: operations.CreateTokenV2LinkCodeCreatePostRequest) -> operations.CreateTokenV2LinkCodeCreatePostResponse:
        r"""Create Token
    ...
    def exchange_token(self, request: operations.ExchangeTokenV2LinkCodeExchangePostRequest) -> operations.ExchangeTokenV2LinkCodeExchangePostResponse:
        r"""Exchange Token
    ...
    def get_oauth_provider(self, request: operations.GetOauthProviderV2LinkProviderOauthOauthProviderGetRequest) -> operations.GetOauthProviderV2LinkProviderOauthOauthProviderGetResponse:
