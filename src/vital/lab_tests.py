...
class LabTests:
    ...
    def create(self, request: shared.CreateLabTestRequest, retries: Optional[utils.RetryConfig] = None) -> operations.CreateLabTestForTeamV3LabTestsPostResponse:
    ...
    def get_labs(self, retries: Optional[utils.RetryConfig] = None) -> operations.GetLabsV3LabTestsLabsGetResponse:
        r"""Get Labs
        GET all the labs.
        """
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
    ...
    def get_marker_by_provider(self, lab_id: int, provider_id: str, retries: Optional[utils.RetryConfig] = None) -> operations.GetMarkersByProviderIDV3LabTestsLabIDMarkersProviderIDGetResponse:
    ...
    def get_markers(self, lab_id: Optional[int] = None, name: Optional[str] = None, page: Optional[int] = None, size: Optional[int] = None, retries: Optional[utils.RetryConfig] = None) -> operations.GetMarkersV3LabTestsMarkersGetResponse:
        r"""Get Markers
    ...
    def list(self, retries: Optional[utils.RetryConfig] = None) -> operations.GetLabTestsForTeamV3LabTestsGetResponse:
