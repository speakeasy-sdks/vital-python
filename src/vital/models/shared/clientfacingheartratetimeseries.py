...
class ClientFacingHeartRateTimeseries:
    ...
    r"""Heart rate in bpm"""
    id: Optional[Any] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('id'), 'exclude': lambda f: f is ClientFacingHeartRateTimeseries.UNSET }})
    r"""Deprecated"""
