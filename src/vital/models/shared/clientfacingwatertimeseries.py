...
class ClientFacingWaterTimeseries:
    ...
    r"""Measured in milliters."""
    value: float = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('value') }})
    r"""Quantity of water drank during the time period."""
    id: Optional[Any] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('id'), 'exclude': lambda f: f is ClientFacingWaterTimeseries.UNSET }})
    r"""Deprecated"""
