...
class ClientFacingHRVTimeseries:
    ...
    r"""HRV calculated using rmssd during sleep"""
    id: Optional[Any] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('id'), 'exclude': lambda f: f is ClientFacingHRVTimeseries.UNSET }})
    r"""Deprecated"""
