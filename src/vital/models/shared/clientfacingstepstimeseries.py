...
class ClientFacingStepsTimeseriesUnit(str, Enum):
...
class ClientFacingStepsTimeseries:
    ...
    unit: ClientFacingStepsTimeseriesUnit = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('unit') }})
    r"""Measured in counts"""
    value: float = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('value') }})
    r"""The number of steps sampled at the time or interval::count"""
    id: Optional[Any] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('id'), 'exclude': lambda f: f is ClientFacingStepsTimeseries.UNSET }})
    r"""Deprecated"""
