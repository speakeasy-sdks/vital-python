...
class ClientFacingRespiratoryRateTimeseries:
    ...
    id: Optional[Any] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('id'), 'exclude': lambda f: f is ClientFacingRespiratoryRateTimeseries.UNSET }})
    r"""Deprecated"""
