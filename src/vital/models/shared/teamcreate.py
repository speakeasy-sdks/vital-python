...
class PhysicianNetworkT(str, Enum):
    r"""An enumeration."""
    WHEEL = 'WHEEL'
    OPENLOOP = 'OPENLOOP'
...
class TeamCreate:
    ...
    physician_network: Optional[PhysicianNetworkT] = dataclasses.field(default=PhysicianNetworkT.OPENLOOP, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('physician_network'), 'exclude': lambda f: f is None }})
