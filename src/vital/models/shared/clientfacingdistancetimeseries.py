...
class ClientFacingDistanceTimeseriesUnit(str, Enum):
...
class ClientFacingDistanceTimeseries:
    ...
    unit: ClientFacingDistanceTimeseriesUnit = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('unit') }})
    r"""Measured in meters (m)"""
