...
class ClientFacingMindfulnessMinutesTimeseries:
    ...
    r"""Measured in minutes."""
    value: float = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('value') }})
    r"""Number of minutes spent in a mindful state."""
    id: Optional[Any] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('id'), 'exclude': lambda f: f is ClientFacingMindfulnessMinutesTimeseries.UNSET }})
    r"""Deprecated"""
