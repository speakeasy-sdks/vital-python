...
class PostUserBodyV2SummaryBodyUserIDPostRequest:
...
@dataclasses.dataclass
class PostUserBodyV2SummaryBodyUserIDPostResponse:
    ...
    response_post_user_body_v2_summary_body_user_id_post: Optional[str] = dataclasses.field(default=None)
