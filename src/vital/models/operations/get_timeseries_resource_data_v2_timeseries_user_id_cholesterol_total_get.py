...
class GetTimeseriesResourceDataV2TimeseriesUserIDCholesterolTotalGetRequest:
...
@dataclasses.dataclass
class GetTimeseriesResourceDataV2TimeseriesUserIDCholesterolTotalGetResponse:
    ...
    response_get_timeseries_resource_data_v2_timeseries_user_id_cholesterol_total_get: Optional[List[shared_clientfacingcholesteroltimeseries.ClientFacingCholesterolTimeseries]] = dataclasses.field(default=None)
