...
class GetTimeseriesResourceDataV2TimeseriesUserIDCholesterolLdlGetRequest:
...
@dataclasses.dataclass
class GetTimeseriesResourceDataV2TimeseriesUserIDCholesterolLdlGetResponse:
    ...
    response_get_timeseries_resource_data_v2_timeseries_user_id_cholesterol_ldl_get: Optional[List[shared_clientfacingcholesteroltimeseries.ClientFacingCholesterolTimeseries]] = dataclasses.field(default=None)
