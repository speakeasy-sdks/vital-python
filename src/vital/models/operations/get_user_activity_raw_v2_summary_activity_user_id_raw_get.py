...
from ...models.shared import rawactivity as shared_rawactivity
from typing import Optional


@dataclasses.dataclass
class GetUserActivityRawV2SummaryActivityUserIDRawGetRequest:
...
@dataclasses.dataclass
class GetUserActivityRawV2SummaryActivityUserIDRawGetResponse:
    content_type: str = dataclasses.field()
    r"""HTTP response content type for this operation"""
    status_code: int = dataclasses.field()
    r"""HTTP response status code for this operation"""
    raw_activity: Optional[shared_rawactivity.RawActivity] = dataclasses.field(default=None)
