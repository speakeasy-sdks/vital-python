...
class GetTimeseriesResourceDataV2TimeseriesUserIDCholesterolGetRequest:
...
@dataclasses.dataclass
class GetTimeseriesResourceDataV2TimeseriesUserIDCholesterolGetResponse:
    ...
    response_get_timeseries_resource_data_v2_timeseries_user_id_cholesterol_get: Optional[List[shared_clientfacingcholesteroltimeseries.ClientFacingCholesterolTimeseries]] = dataclasses.field(default=None)
