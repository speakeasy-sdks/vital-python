...
from ...models.shared import clientfacingbloodoxygentimeseries as shared_clientfacingbloodoxygentimeseries
from typing import List, Optional


@dataclasses.dataclass
class GetTimeseriesResourceDataV2TimeseriesUserIDBloodOxygenGetRequest:
...
@dataclasses.dataclass
class GetTimeseriesResourceDataV2TimeseriesUserIDBloodOxygenGetResponse:
    ...
    response_get_timeseries_resource_data_v2_timeseries_user_id_blood_oxygen_get: Optional[List[shared_clientfacingbloodoxygentimeseries.ClientFacingBloodOxygenTimeseries]] = dataclasses.field(default=None)
