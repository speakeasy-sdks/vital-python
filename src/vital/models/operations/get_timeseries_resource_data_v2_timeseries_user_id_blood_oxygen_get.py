...
from ..shared import clientfacingbloodoxygentimeseries as shared_clientfacingbloodoxygentimeseries
...
class GetTimeseriesResourceDataV2TimeseriesUserIDBloodOxygenGetResponse:
    ...
    client_facing_blood_oxygen_timeseries: Optional[List[shared_clientfacingbloodoxygentimeseries.ClientFacingBloodOxygenTimeseries]] = dataclasses.field(default=None)
