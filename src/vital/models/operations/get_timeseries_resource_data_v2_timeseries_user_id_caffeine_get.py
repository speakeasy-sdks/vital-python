...
from ...models.shared import clientfacingcaffeinetimeseries as shared_clientfacingcaffeinetimeseries
from typing import List, Optional


@dataclasses.dataclass
class GetTimeseriesResourceDataV2TimeseriesUserIDCaffeineGetRequest:
...
class GetTimeseriesResourceDataV2TimeseriesUserIDCaffeineGetResponse:
    ...
    response_get_timeseries_resource_data_v2_timeseries_user_id_caffeine_get: Optional[List[shared_clientfacingcaffeinetimeseries.ClientFacingCaffeineTimeseries]] = dataclasses.field(default=None)
