...
from ...models.shared import clientfacingwatertimeseries as shared_clientfacingwatertimeseries
...
class GetTimeseriesResourceDataV2TimeseriesUserIDWaterGetResponse:
    ...
    response_get_timeseries_resource_data_v2_timeseries_user_id_water_get: Optional[List[shared_clientfacingwatertimeseries.ClientFacingWaterTimeseries]] = dataclasses.field(default=None)
