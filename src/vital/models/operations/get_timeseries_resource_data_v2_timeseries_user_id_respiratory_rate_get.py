...
class GetTimeseriesResourceDataV2TimeseriesUserIDRespiratoryRateGetResponse:
    ...
    client_facing_respiratory_rate_timeseries: Optional[List[shared_clientfacingrespiratoryratetimeseries.ClientFacingRespiratoryRateTimeseries]] = dataclasses.field(default=None)
