...
from ...models.shared import clientfacingrespiratoryratetimeseries as shared_clientfacingrespiratoryratetimeseries
from typing import List, Optional


@dataclasses.dataclass
class GetTimeseriesResourceDataV2TimeseriesUserIDRespiratoryRateGetRequest:
...
@dataclasses.dataclass
class GetTimeseriesResourceDataV2TimeseriesUserIDRespiratoryRateGetResponse:
    ...
    response_get_timeseries_resource_data_v2_timeseries_user_id_respiratory_rate_get: Optional[List[shared_clientfacingrespiratoryratetimeseries.ClientFacingRespiratoryRateTimeseries]] = dataclasses.field(default=None)
