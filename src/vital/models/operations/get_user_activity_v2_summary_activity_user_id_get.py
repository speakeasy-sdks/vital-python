...
from ...models.shared import clientactivityresponse as shared_clientactivityresponse
from typing import Optional


@dataclasses.dataclass
class GetUserActivityV2SummaryActivityUserIDGetRequest:
...
@dataclasses.dataclass
class GetUserActivityV2SummaryActivityUserIDGetResponse:
    content_type: str = dataclasses.field()
    r"""HTTP response content type for this operation"""
    status_code: int = dataclasses.field()
    r"""HTTP response status code for this operation"""
    client_activity_response: Optional[shared_clientactivityresponse.ClientActivityResponse] = dataclasses.field(default=None)
