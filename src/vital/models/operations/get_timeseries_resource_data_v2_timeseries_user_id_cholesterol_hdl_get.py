...
class GetTimeseriesResourceDataV2TimeseriesUserIDCholesterolHdlGetRequest:
...
@dataclasses.dataclass
class GetTimeseriesResourceDataV2TimeseriesUserIDCholesterolHdlGetResponse:
    ...
    response_get_timeseries_resource_data_v2_timeseries_user_id_cholesterol_hdl_get: Optional[List[shared_clientfacingcholesteroltimeseries.ClientFacingCholesterolTimeseries]] = dataclasses.field(default=None)
