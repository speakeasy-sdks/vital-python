...
from ...models.shared import clientfacinghypnogramtimeseries as shared_clientfacinghypnogramtimeseries
from typing import List, Optional


@dataclasses.dataclass
class GetTimeseriesResourceDataV2TimeseriesUserIDHypnogramGetRequest:
...
@dataclasses.dataclass
class GetTimeseriesResourceDataV2TimeseriesUserIDHypnogramGetResponse:
    ...
    response_get_timeseries_resource_data_v2_timeseries_user_id_hypnogram_get: Optional[List[shared_clientfacinghypnogramtimeseries.ClientFacingHypnogramTimeseries]] = dataclasses.field(default=None)
