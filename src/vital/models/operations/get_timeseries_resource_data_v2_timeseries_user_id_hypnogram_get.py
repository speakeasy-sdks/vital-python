...
class GetTimeseriesResourceDataV2TimeseriesUserIDHypnogramGetResponse:
    ...
    client_facing_hypnogram_timeseries: Optional[list[shared_clientfacinghypnogramtimeseries.ClientFacingHypnogramTimeseries]] = dataclasses.field(default=None)
