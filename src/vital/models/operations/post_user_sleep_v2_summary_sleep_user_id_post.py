...
class PostUserSleepV2SummarySleepUserIDPostRequest:
...
@dataclasses.dataclass
class PostUserSleepV2SummarySleepUserIDPostResponse:
    ...
    response_post_user_sleep_v2_summary_sleep_user_id_post: Optional[str] = dataclasses.field(default=None)
