...
class GetTimeseriesResourceDataV2TimeseriesUserIDHeartrateGetResponse:
    ...
    client_facing_heart_rate_timeseries: Optional[List[shared_clientfacingheartratetimeseries.ClientFacingHeartRateTimeseries]] = dataclasses.field(default=None)
