...
from ...models.shared import clientfacingheartratetimeseries as shared_clientfacingheartratetimeseries
from typing import List, Optional


@dataclasses.dataclass
class GetTimeseriesResourceDataV2TimeseriesUserIDHeartrateGetRequest:
...
@dataclasses.dataclass
class GetTimeseriesResourceDataV2TimeseriesUserIDHeartrateGetResponse:
    ...
    response_get_timeseries_resource_data_v2_timeseries_user_id_heartrate_get: Optional[List[shared_clientfacingheartratetimeseries.ClientFacingHeartRateTimeseries]] = dataclasses.field(default=None)
