...
from ...models.shared import clientfacingbloodpressuretimeseries as shared_clientfacingbloodpressuretimeseries
from typing import List, Optional


@dataclasses.dataclass
class GetTimeseriesResourceDataV2TimeseriesUserIDBloodPressureGetRequest:
...
@dataclasses.dataclass
class GetTimeseriesResourceDataV2TimeseriesUserIDBloodPressureGetResponse:
    ...
    response_get_timeseries_resource_data_v2_timeseries_user_id_blood_pressure_get: Optional[List[shared_clientfacingbloodpressuretimeseries.ClientFacingBloodPressureTimeseries]] = dataclasses.field(default=None)
