...
from ..shared import clientfacingcholesteroltimeseries as shared_clientfacingcholesteroltimeseries
...
class GetTimeseriesResourceDataV2TimeseriesUserIDCholesterolTriglyceridesGetResponse:
    ...
    client_facing_cholesterol_timeseries: Optional[list[shared_clientfacingcholesteroltimeseries.ClientFacingCholesterolTimeseries]] = dataclasses.field(default=None)
