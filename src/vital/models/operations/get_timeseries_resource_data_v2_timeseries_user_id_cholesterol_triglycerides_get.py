...
from ...models.shared import clientfacingcholesteroltimeseries as shared_clientfacingcholesteroltimeseries
from typing import List, Optional


@dataclasses.dataclass
class GetTimeseriesResourceDataV2TimeseriesUserIDCholesterolTriglyceridesGetRequest:
...
@dataclasses.dataclass
class GetTimeseriesResourceDataV2TimeseriesUserIDCholesterolTriglyceridesGetResponse:
    ...
    response_get_timeseries_resource_data_v2_timeseries_user_id_cholesterol_triglycerides_get: Optional[List[shared_clientfacingcholesteroltimeseries.ClientFacingCholesterolTimeseries]] = dataclasses.field(default=None)
