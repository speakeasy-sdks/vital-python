...
from ...models.shared import clientfacingmindfulnessminutestimeseries as shared_clientfacingmindfulnessminutestimeseries
from typing import List, Optional


@dataclasses.dataclass
class GetTimeseriesResourceDataV2TimeseriesUserIDMindfulnessMinutesGetRequest:
...
@dataclasses.dataclass
class GetTimeseriesResourceDataV2TimeseriesUserIDMindfulnessMinutesGetResponse:
    ...
    response_get_timeseries_resource_data_v2_timeseries_user_id_mindfulness_minutes_get: Optional[List[shared_clientfacingmindfulnessminutestimeseries.ClientFacingMindfulnessMinutesTimeseries]] = dataclasses.field(default=None)
