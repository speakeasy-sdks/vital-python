...
from ..shared import clientfacingigetimeseries as shared_clientfacingigetimeseries
...
class GetTimeseriesResourceDataV2TimeseriesUserIDIgeGetResponse:
    ...
    client_facing_ige_timeseries: Optional[list[shared_clientfacingigetimeseries.ClientFacingIgeTimeseries]] = dataclasses.field(default=None)
