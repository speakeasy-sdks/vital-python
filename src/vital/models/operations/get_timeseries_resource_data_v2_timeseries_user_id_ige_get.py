...
from ...models.shared import clientfacingigetimeseries as shared_clientfacingigetimeseries
from typing import List, Optional


@dataclasses.dataclass
class GetTimeseriesResourceDataV2TimeseriesUserIDIgeGetRequest:
...
@dataclasses.dataclass
class GetTimeseriesResourceDataV2TimeseriesUserIDIgeGetResponse:
    ...
    response_get_timeseries_resource_data_v2_timeseries_user_id_ige_get: Optional[List[shared_clientfacingigetimeseries.ClientFacingIgeTimeseries]] = dataclasses.field(default=None)
