...
class Insurance:
    ...
    def search_diagnosis(self, diagnosis_query: str) -> operations.SearchDiagnosisV3InsuranceSearchDiagnosisGetResponse:
        r"""Search Diagnosis"""
        hook_ctx = HookContext(operation_id='search_diagnosis_v3_insurance_search_diagnosis_get', oauth2_scopes=[], security_source=None)
        ...
        query_params = { **utils.get_query_params(operations.SearchDiagnosisV3InsuranceSearchDiagnosisGetRequest, request), **query_params }
        ...
        res = operations.SearchDiagnosisV3InsuranceSearchDiagnosisGetResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def search_insurance_payor_info(self, request: shared.PayorSearchRequest) -> operations.SearchInsurancePayorInformationV3InsuranceSearchPayorPostResponse:
        ...
        hook_ctx = HookContext(operation_id='search_insurance_payor_information_v3_insurance_search_payor_post', oauth2_scopes=[], security_source=None)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
        ...
        req_content_type, data, form = utils.serialize_request_body(request, shared.PayorSearchRequest, "request", False, False, 'json')
        ...
        res = operations.SearchInsurancePayorInformationV3InsuranceSearchPayorPostResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
