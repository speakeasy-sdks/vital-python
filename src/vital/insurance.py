...
class Insurance:
    ...
    def search_diagnosis(self, diagnosis_query: str, retries: Optional[utils.RetryConfig] = None) -> operations.SearchDiagnosisV3InsuranceSearchDiagnosisGetResponse:
        r"""Search Diagnosis"""
    ...
    def search_insurance_payor_info(self, request: shared.PayorSearchRequest, retries: Optional[utils.RetryConfig] = None) -> operations.SearchInsurancePayorInformationV3InsuranceSearchPayorPostResponse:
